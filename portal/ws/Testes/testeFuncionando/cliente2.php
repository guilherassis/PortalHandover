...
$wsdl = 'http://operacaotv.telemar/ws/teste/server2.php?wsdl'; // ex.: http://localhost/imasters/nuSOAP/server2.php?wsdl
...
$result = $client->call('hello',array('Teste do Teste')); 
