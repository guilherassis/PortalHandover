...
<?php
for($QtdeAppServer = 0; $QtdeAppServer < 2; $QtdeAppServer++){
...
function verificaStatusServicoLoginSINN($NomeAppServer, $NumPorta){
   ...
   $wsdl = "http://10.32.209.165:".$NumPorta."/webservices-ura/UraWs";
...
function GravarLog($msg){
	...
	$fp = fopen("teste_log_consulta_contrato_ura_".date("Y-m-d").".txt", "a+");
