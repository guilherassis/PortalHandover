...
<html>
<head>
<title>Veririca Serviços de Login do SINN Web</title>
...
for($controle = 0; $controle < 8; $controle++){
	...
	echo "<tr><td class='Titulo'>".$nomeServer.":".$numPorta."</td><td>".verificaStatusServicoLoginSINN($nomeServer, $numPorta)."&nbsp;</td></tr>";
